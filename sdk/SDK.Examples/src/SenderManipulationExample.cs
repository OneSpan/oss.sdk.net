...
namespace SDK.Examples
{
    public class SenderManipulationExample : SDKSample
    {
        ...
        override public void Execute()
        {
            ...
            accountMembers = eslClient.AccountService.GetSenders(Direction.ASCENDING, new PageRequest(0, -1));

            eslClient.AccountService.DeleteSender(createdSender2.Id);

            accountMembersWithDeletedSender = eslClient.AccountService.GetSenders(Direction.ASCENDING, new PageRequest(0, -1));
            ...
            accountMembersWithUpdatedSender = eslClient.AccountService.GetSenders(Direction.ASCENDING, new PageRequest(0, -1));
        }
    }
}
