...
namespace SDK.Examples
{
    public class CreatePackageFromTemplateWithFieldsExample : SDKSample
    {
        ...
        {
            new CreatePackageFromTemplateWithFieldsExample(Props.GetInstance()).Run();
        }
        ...
        public CreatePackageFromTemplateWithFieldsExample(Props props) : this(props.Get("api.key"), props.Get("api.url"), props.Get("1.email"), props.Get("2.email"))
        {
        }

        public CreatePackageFromTemplateWithFieldsExample(string apiKey, string apiUrl, string email1, string email2) : base(apiKey, apiUrl)
        {
            this.email1 = email1;
            this.email2 = email2;
