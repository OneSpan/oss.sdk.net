...
namespace OneSpanSign.Sdk
{
    ...
    {
		private OneSpanSign.Sdk.NotificationEvent sdkNotificationEvent;
		...
		public EventNotificationConverter(OneSpanSign.Sdk.NotificationEvent sdkNotificationEvent)
        {
		...
		internal OneSpanSign.Sdk.NotificationEvent ToSDKNotificationEvent()
		{
            return OneSpanSign.Sdk.NotificationEvent.valueOf(apiCallbackEvent);
		}
    }
}
