...
namespace OneSpanSign.Sdk.Services
{
	public class CustomFieldService
	{
		...
		/// @throws com.OneSpanSign.Sdk.OssException
		///
		public CustomField CreateCustomField(CustomField customField)
		{
            OneSpanSign.API.CustomField apiCustomField = new CustomFieldConverter( customField ).ToAPICustomField();
        ...
        {
            IList<OneSpanSign.API.CustomField> apiCustomFieldList = apiClient.GetCustomFields(direction, request);

            IList<OneSpanSign.Sdk.CustomField> result = new List<OneSpanSign.Sdk.CustomField>();
            foreach (OneSpanSign.API.CustomField apiCustomField in apiCustomFieldList)
            {
