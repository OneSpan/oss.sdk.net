...
namespace SDK.Examples
{
    public class TextTagsExample : SDKSample
    {
        ...
        {
            this.fileStream1 = File.OpenRead(new FileInfo(Directory.GetCurrentDirectory() + "/SampleDocuments/Text_Tag_And_Acrobat_Form_Fields.pdf").FullName);
            this.fileStream2 = File.OpenRead(new FileInfo(Directory.GetCurrentDirectory() + "/SampleDocuments/Text_Tag_And_Acrobat_Form_Fields.pdf").FullName);
            this.fileStream3 = File.OpenRead(new FileInfo(Directory.GetCurrentDirectory() + "/SampleDocuments/Text_Tag_And_Acrobat_Form_Fields.pdf").FullName);
