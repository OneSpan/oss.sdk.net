...
namespace SDK.Examples
{
    public class ConditionalFieldExample : SDKSample
    {
        ...
        public override void Execute ()
        {
            ...
            ossClient.ApprovalService.ModifyConditionalField (packageId, documentId, signatureId, conditionalField);
            RetrievedPackageWithUpdatedConditions = ossClient.GetPackage (packageId);

            conditions.Clear ();
            conditionalField.Conditions = conditions;
            ossClient.ApprovalService.ModifyConditionalField (packageId, documentId, signatureId, conditionalField);
            RetrievedPackageWithoutConditions = ossClient.GetPackage (packageId);
