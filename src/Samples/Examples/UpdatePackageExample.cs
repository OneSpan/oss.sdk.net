...
namespace SDK.Examples
{
    public class UpdatePackageExample : SDKSample
    {
        ...
        public readonly DateTime OLD_EXPIRY_DATE = DateTime.UtcNow.AddMonths(2).AddDays(-2);
        ...
        public readonly DateTime NEW_EXPIRY_DATE = DateTime.UtcNow.AddMonths(2).AddDays(-3);
