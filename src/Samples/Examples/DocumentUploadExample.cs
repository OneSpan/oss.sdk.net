...
namespace SDK.Examples
{
    public class DocumentUploadExample : SDKSample
    {
        ...
        override public void Execute()
        {
            ...
            this.fileStream2 = File.OpenRead(new FileInfo(Directory.GetCurrentDirectory() + "/SampleDocuments/taggedDocument.pdf").FullName);
            ...
            uploadedDocuments = ossClient.UploadDocuments(packageId, document1, document2);
