    ...
    public class SignerAuthenticationTokenExample : SDKSample
    {
        ...
        **/
        ...
        override public void Execute()
        {
            ...
            string signerAuthenticationToken = ossClient.AuthenticationTokenService.CreateSignerAuthenticationToken(packageId, signerId, signerSessionFields);
            string signerAuthenticationTokenForSingleUse = ossClient.AuthenticationTokenService.CreateSignerAuthenticationTokenForSingleUse(packageId, signerId, signerSessionFields);
