...
namespace SDK.Examples
{
	public class EventNotificationRegistrationExample : SDKSample
	{
		...
		override public void Execute()
		{
			...
			config = ossClient.EventNotificationService.GetEventNotificationConfig();
            ...
            connectorsConfig = ossClient.EventNotificationService.GetEventNotificationConfig(ORIGIN);
		}
	}
}
