...
namespace SDK.Examples
{
    public class DeleteDocumentsExample : SDKSample
    {
        ...
        override public void Execute ()
        {
            ...
            ossClient.PackageService.DeleteDocuments (packageId, retrievedPackage.GetDocument(DOCUMENT1_NAME).Id, 
                                                      retrievedPackage.GetDocument (DOCUMENT2_NAME).Id);

            RetrievedPackageWithDeletedDocuments = ossClient.GetPackage (packageId);
        }
    }
