...
namespace SDK.Examples
{
    public class CreateTemplateOnBehalfOfAnotherSenderExample : SDKSample
    {
        ...
        override public void Execute()
        {
            ...
            ossClient.AccountService.InviteUser(AccountMemberBuilder.NewAccountMember(senderEmail)
            ...
            packageId = ossClient.CreatePackageFromTemplate(templateId, packageFromTemplate);
