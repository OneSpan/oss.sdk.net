...
namespace SDK.Examples
{
    public class SenderManipulationExample : SDKSample
    {
        ...
        override public void Execute()
        {
            ...
            ossClient.AccountService.SendInvite(createdSender1.Id);

            ossClient.AccountService.DeleteSender(createdSender2.Id);
            ...
            ossClient.AccountService.UpdateSender(updatedSenderInfo, createdSender3.Id);
            retrievedUpdatedSender3 = ossClient.AccountService.GetSender(createdSender3.Id);

            // Get senders in account
            IDictionary<string, Sender> senders = ossClient.AccountService.GetSenders(Direction.ASCENDING, new PageRequest(1, 100));
        }
    }
}
