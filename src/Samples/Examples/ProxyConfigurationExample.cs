...
namespace SDK.Examples
{
    public class ProxyConfigurationExample : SDKSample
    {
        ...
        public OssClient ossClientWithHttpProxy, ossClientWithHttpProxyHasCredentials;
        ...
        public ProxyConfigurationExample(string apiKey, string apiUrl) : base(apiKey, apiUrl)
        {
            ...
            ossClientWithHttpProxy = new OssClient(apiKey, apiUrl, allowAllSSLCertificates, httpProxyConfiguration);
            ossClientWithHttpProxyHasCredentials = new OssClient(apiKey, apiUrl, allowAllSSLCertificates, httpProxyWithCredentialsConfiguration);
        }
        ...
        override public void Execute()
        {
            ...
            packageId1 = ossClientWithHttpProxy.CreateAndSendPackage(package1);
            ossClientWithHttpProxy.SignDocuments (packageId1);
            ossClientWithHttpProxy.SignDocuments (packageId1, "signer1");
            ...
            packageId2 = ossClientWithHttpProxyHasCredentials.CreateAndSendPackage(package2);
            ossClientWithHttpProxyHasCredentials.SignDocuments (packageId2);
            ossClientWithHttpProxyHasCredentials.SignDocuments (packageId2, "signer2");
