...
namespace SDK.Examples
{
    public class CustomFieldExampleTest
    {
		...
		public void verify() {
            ...
            Assert.IsTrue(example.OssClient.GetCustomFieldService().DoesCustomFieldExist(example.customFieldId1));
            Assert.IsFalse(example.OssClient.GetCustomFieldService().DoesCustomFieldExist(example.customFieldId2));
