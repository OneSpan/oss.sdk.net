        ...
        public void VerifyResult()
        {
            ...
            foreach (Signature signature in documentPackage.GetDocument(ClickableAreaExample.DOCUMENT_NAME).Signatures)
            {
                foreach (Field field in signature.Fields)
                {
                    ...
                    if (field.Id == ClickableAreaExample.CHECKBOX_ID && field.ClickableArea != null)
                    {
                    ...
                    if (field.Id == ClickableAreaExample.ALIGNED_CHECKBOX_ID && field.ClickableArea != null)
                    {
                    ...
                    if (field.Id == ClickableAreaExample.RADIO_ID && field.ClickableArea != null)
                    {
                    ...
                    if (field.Id == ClickableAreaExample.ADDED_CHECKBOX_ID && field.ClickableArea != null)
                    {
