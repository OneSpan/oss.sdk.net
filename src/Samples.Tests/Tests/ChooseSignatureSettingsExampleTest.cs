...
namespace SDK.Examples
{
    ...
    public class ChooseSignatureSettingsExampleTest
    {
        ...
        public void VerifyResult ()
        {
            ...
            Assert.AreEqual(example.defaultChooseSignatureSettings.Signature.DefaultSignatureType, ChooseSignatureStyleType.STYLE.GetName());
            ...
            Assert.AreEqual(example.chooseSignatureSettingsAfterPatch.Signature.DefaultSignatureType, ChooseSignatureStyleType.DRAW.GetName());
            ...
            Assert.AreEqual(example.chooseSignatureSettingsAfterDelete.Signature.DefaultSignatureType, ChooseSignatureStyleType.STYLE.GetName());
