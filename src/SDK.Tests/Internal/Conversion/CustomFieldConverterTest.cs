...
namespace SDK.Tests
{
    ...
    {
		private OneSpanSign.Sdk.CustomField sdkCustomField1 = null;
		private OneSpanSign.Sdk.CustomField sdkCustomField2 = null;
		private OneSpanSign.API.CustomField apiCustomField1 = null;
		private OneSpanSign.API.CustomField apiCustomField2 = null;
		private OneSpanSign.Sdk.CustomFieldConverter converter = null;
		...
		private OneSpanSign.API.CustomField CreateTypicalAPICustomField()
		{
			OneSpanSign.API.CustomField apiCustomField = new OneSpanSign.API.CustomField();
			apiCustomField.Id = "1";
