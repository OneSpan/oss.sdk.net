...
namespace SDK.Tests
{
    ...
    {
        private OneSpanSign.Sdk.Challenge sdkAuthChallenge1 = null;
        private OneSpanSign.Sdk.Challenge sdkAuthChallenge2 = null;
        private OneSpanSign.API.AuthChallenge apiAuthChallenge1 = null;
        private OneSpanSign.API.AuthChallenge apiAuthChallenge2 = null;
        ...
        private OneSpanSign.Sdk.Challenge CreateTypicalSDKChallenge()
        {
            return new OneSpanSign.Sdk.Challenge("What is the name of your dog?", "Max", Challenge.MaskOptions.MaskInput);
        }
